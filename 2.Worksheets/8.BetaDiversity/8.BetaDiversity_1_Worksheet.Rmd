...
```{r}
order <- rev(attr(fish.db,"Labels"))
levelplot(as.matrix(fish.db)[,order],aspect="iso",col.regions=viridisu,xlab="Doubs Site",ylab="Doubs Site", main="Bray-Curtis Distance",scales=list(cex=0.5))
``` 
...
> I don't get this question in terms of the heterogenous community. The source community by definition in the heterogenous community is non random. 

```{r}
#generate species richness for comA and comB
